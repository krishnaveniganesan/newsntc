...
public class EmailTemplate
{
	...
	{
		if (com.mendix.core.Core.isSubClassOf("MyFirstModule.Communication", mendixObject.getType())) {
	...
	public static java.util.List<? extends emailtemplate.proxies.EmailTemplate> load(com.mendix.systemwideinterfaces.core.IContext context, java.lang.String xpathConstraint) throws com.mendix.core.CoreException
	{
