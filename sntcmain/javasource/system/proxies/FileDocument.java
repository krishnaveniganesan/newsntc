...
public class FileDocument
{
	...
	public static system.proxies.FileDocument initialize(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixObject mendixObject)
	{
		...
		if (com.mendix.core.Core.isSubClassOf("MyFirstModule.Attachments", mendixObject.getType())) {
			return myfirstmodule.proxies.Attachments.initialize(context, mendixObject);
		}
		if (com.mendix.core.Core.isSubClassOf("MyFirstModule.Bank_statements", mendixObject.getType())) {
			return myfirstmodule.proxies.Bank_statements.initialize(context, mendixObject);
		}
		if (com.mendix.core.Core.isSubClassOf("MyFirstModule.CPF_documents", mendixObject.getType())) {
		...
		if (com.mendix.core.Core.isSubClassOf("MyFirstModule.NRIC_documents", mendixObject.getType())) {
		...
		if (com.mendix.core.Core.isSubClassOf("MyFirstModule.cheques", mendixObject.getType())) {
