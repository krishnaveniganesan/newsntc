...
public class Image extends system.proxies.FileDocument
{
	...
	{
		if (com.mendix.core.Core.isSubClassOf("MyFirstModule.Applicant", mendixObject.getType())) {
			return myfirstmodule.proxies.Applicant.initialize(context, mendixObject);
		}
		if (com.mendix.core.Core.isSubClassOf("MyFirstModule.Applicant_2", mendixObject.getType())) {
