...
public class Paging
{
	...
	{
		if (com.mendix.core.Core.isSubClassOf("MyFirstModule.DS_Review_and_Submit_Overview_DataGrid", mendixObject.getType())) {
			return myfirstmodule.proxies.DS_Review_and_Submit_Overview_DataGrid.initialize(context, mendixObject);
		}
		if (com.mendix.core.Core.isSubClassOf("MyFirstModule.DS_Review_and_Submit_Overview_TemplateGrid", mendixObject.getType())) {
