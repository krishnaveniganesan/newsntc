...
public class Account extends system.proxies.User
{
	...
	public enum MemberNames
	{
		...
		Account_Applicant("Administration.Account_Applicant"),
	...
	/**
	 * @return value of IsSidebarOpen
	 */
	public final java.lang.Boolean getIsSidebarOpen()
	{
		return getIsSidebarOpen(getContext());
	}
	 ...
	 * @return value of IsSidebarOpen
	 */
	public final java.lang.Boolean getIsSidebarOpen(com.mendix.systemwideinterfaces.core.IContext context)
	{
		return (java.lang.Boolean) getMendixObject().getValue(context, MemberNames.IsSidebarOpen.toString());
	}

	/**
	 * Set value of IsSidebarOpen
	 * @param issidebaropen
	 */
	public final void setIsSidebarOpen(java.lang.Boolean issidebaropen)
	{
		setIsSidebarOpen(getContext(), issidebaropen);
	}
	 ...
	 * @param issidebaropen
	 */
	public final void setIsSidebarOpen(com.mendix.systemwideinterfaces.core.IContext context, java.lang.Boolean issidebaropen)
	{
		getMendixObject().setValue(context, MemberNames.IsSidebarOpen.toString(), issidebaropen);
	}

	/**
	 * @throws com.mendix.core.CoreException
	 * @return value of Account_Applicant
	 */
	public final myfirstmodule.proxies.Applicant getAccount_Applicant() throws com.mendix.core.CoreException
	{
		return getAccount_Applicant(getContext());
	}
	 ...
	 * @throws com.mendix.core.CoreException
	 */
	public final myfirstmodule.proxies.Applicant getAccount_Applicant(com.mendix.systemwideinterfaces.core.IContext context) throws com.mendix.core.CoreException
	{
		myfirstmodule.proxies.Applicant result = null;
		com.mendix.systemwideinterfaces.core.IMendixIdentifier identifier = getMendixObject().getValue(context, MemberNames.Account_Applicant.toString());
		if (identifier != null) {
	...
	/**
	 * Set value of Account_Applicant
	 * @param account_applicant
	 */
	public final void setAccount_Applicant(myfirstmodule.proxies.Applicant account_applicant)
	{
		setAccount_Applicant(getContext(), account_applicant);
	}
	 ...
	 * @param account_applicant
	 */
	public final void setAccount_Applicant(com.mendix.systemwideinterfaces.core.IContext context, myfirstmodule.proxies.Applicant account_applicant)
	{
		if (account_applicant == null) {
			getMendixObject().setValue(context, MemberNames.Account_Applicant.toString(), null);
		} else {
			getMendixObject().setValue(context, MemberNames.Account_Applicant.toString(), account_applicant.getMendixObject().getId());
		}
	}
	 ...
	 */
	public final myfirstmodule.proxies.Profile getProfile_Account() throws com.mendix.core.CoreException
	{
	 ...
	 * @throws com.mendix.core.CoreException
	 */
	public final myfirstmodule.proxies.Profile getProfile_Account(com.mendix.systemwideinterfaces.core.IContext context) throws com.mendix.core.CoreException
	{
	 ...
	 */
	public final void setProfile_Account(myfirstmodule.proxies.Profile profile_account)
	{
	 ...
	 * @param profile_account
	 */
	public final void setProfile_Account(com.mendix.systemwideinterfaces.core.IContext context, myfirstmodule.proxies.Profile profile_account)
	{
